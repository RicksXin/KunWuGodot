...
const INPUT_ATLAS := "res://assets/compiled/map01_difficult/dual_grid_15piece.png"
const OUTPUT_ATLAS := "res://assets/compiled/map01_difficult/tilemapdual_standard.png"
const TILESET_PATH := "res://resources/tilemapdual_map01_difficult.tres"
const SCENE_PATH := "res://scenes/tilemapdual_difficult_demo.tscn"
...
func _init() -> void:
	...
	assert(saved_tile_set != null, "Unable to reload difficult TileSet: %s" % TILESET_PATH)
...
func _build_standard_atlas() -> Image:
	...
	assert(not image.is_empty(), "Unable to load difficult atlas: %s" % INPUT_ATLAS)
...
func _build_tileset(atlas_image: Image) -> TileSet:
	...
	tile_set.add_terrain(0)
	tile_set.set_terrain_name(0, 1, "Map01 Crushed Slate")
...
func _build_scene(tile_set: TileSet) -> void:
	...
	root_node.name = "TileMapDualDifficultDemo"
