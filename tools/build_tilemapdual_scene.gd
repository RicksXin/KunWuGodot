...
const INPUT_ATLAS := "res://assets/compiled/dual_grid_15piece.png"
const OUTPUT_ATLAS := "res://assets/compiled/tilemapdual_standard.png"
...
func _init() -> void:
	...
	if not FileAccess.file_exists(TILEMAP_DUAL_SCRIPT):
		printerr("TileMapDual plugin is missing: %s" % TILEMAP_DUAL_SCRIPT)
		quit(2)
		return
